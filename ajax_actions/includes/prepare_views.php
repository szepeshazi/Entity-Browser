<?php
    ...
    $annotations_properties = array('id', 'entity_guid', 'name', 'value', 'owner_guid', 'access_id', 'name_id', 'value_id', 'value_type', 'time_created');
    $relationships_properties = array('id', 'guid_one', 'relationship', 'guid_two');
    $river_properties = array('id', 'type', 'subtype', 'action_type', 'subject_guid', 'object_guid', 'access_id', 'view',  'annotation_id', 'posted');
