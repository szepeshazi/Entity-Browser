 ...
 */
    ...
    $default_infos = array(
        'info_type:entity_guid' => 'entity_info',
...
<script type="text/javascript">
    ...
    $('.view_toggle').click(function() {
        ...
        if (!outer_layout.state.south.isClosed) {
            ...
            $.ajax({
                url: '<?php echo $CONFIG->wwwroot; ?>mod/entity_browser/ajax_actions/get' + id + '.php',
    ...
    $('td.infobox').poshytip({
        ...
        content: function(updateCallback) {
            if ($(this).hasClass('time_info')) {
                ...
                $.ajax({
                    url: '<?php echo $CONFIG->wwwroot; ?>mod/entity_browser/ajax_actions/entity_info.php?guid=' + parseInt($(this).html()),
                    global: false,
                    success: function(data, textStatus, request) {
                        updateCallback(data);
                        return true;
                ...
                $.ajax({
                    url: '<?php echo $CONFIG->wwwroot; ?>mod/entity_browser/ajax_actions/property_info.php?guid=' + guid + '&property=' + property,
                    global: false,
                    success: function(data, textStatus, request) {
                        updateCallback(data);
                        return true;
